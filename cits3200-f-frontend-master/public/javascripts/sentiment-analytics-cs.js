...
(function($) {
  ...
  function loadResults(questionNum, gender, ageRange, employStatus, startYYYY_MM_DD, endYYYY_MM_DD) {
    $.ajax({
      ...
      success: function (data) { // data is the JSON object returned from SQL via controller
        ...
        ResponsesText = data.responsesText;
  ...
  document.getElementById("previousResponse").onclick = function(evt){
    document.getElementById('responseText').innerHTML = ResponsesText[2];
    };



  document.getElementById("nextResponse").onclick = function(evt){
    document.getElementById('responseText').innerHTML = ResponsesText[3];
          };
  ...
  function fillResponseDetails() {
    ...
    document.getElementById('responseText').innerHTML = ResponsesText[0];
  }


  //ResponseText = ResponsesText[1];
